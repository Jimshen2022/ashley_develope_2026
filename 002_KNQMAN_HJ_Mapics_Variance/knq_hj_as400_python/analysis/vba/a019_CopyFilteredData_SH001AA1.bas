Attribute VB_Name = "a019_CopyFilteredData_SH001AA1"
Sub a019_CopyFilteredData_SH001AA1_()
    ...
    Set wsDest = ThisWorkbook.Sheets("SH001AA1")
    If wsDest Is Nothing Then
        Set wsDest = ThisWorkbook.Sheets.Add
        wsDest.Name = "SH001AA1"
    End If
    On Error GoTo 0
    ...
    wsSource.Range(wsSource.Cells(1, 1), wsSource.Cells(lastRow, lastCol)).AutoFilter Field:=locationCol, Criteria1:="SH001AA1"
