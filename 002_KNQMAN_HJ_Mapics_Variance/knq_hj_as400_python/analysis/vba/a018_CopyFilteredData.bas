Attribute VB_Name = "a018_CopyFilteredData"
Sub a018_CopyFilteredData_()
    ...
    Set wsDest = ThisWorkbook.Sheets("EX001AA1")
    If wsDest Is Nothing Then
        Set wsDest = ThisWorkbook.Sheets.Add
        wsDest.Name = "EX001AA1"
    End If
    On Error GoTo 0
    ...
    ' Apply AutoFilter to filter only rows where Location = EX001AA1
    wsSource.Range(wsSource.Cells(1, 1), wsSource.Cells(lastRow, lastCol)).AutoFilter Field:=locationCol, Criteria1:="EX001AA1"
...
'    MsgBox "Data copy completed!", vbInformation
End Sub
