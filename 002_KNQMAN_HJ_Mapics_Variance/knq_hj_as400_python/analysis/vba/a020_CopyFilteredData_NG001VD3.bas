Attribute VB_Name = "a020_CopyFilteredData_NG001VD3"
Sub a020_CopyFilteredData_NG001VD3_()
    ...
    Set wsDest = ThisWorkbook.Sheets("NG001VD3")
    If wsDest Is Nothing Then
        Set wsDest = ThisWorkbook.Sheets.Add
        wsDest.Name = "NG001VD3"
    End If
    On Error GoTo 0
    ...
    wsSource.Range(wsSource.Cells(1, 1), wsSource.Cells(lastRow, lastCol)).AutoFilter Field:=locationCol, Criteria1:="NG001VD3"
