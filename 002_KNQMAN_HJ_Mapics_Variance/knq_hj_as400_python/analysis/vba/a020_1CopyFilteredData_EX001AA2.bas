Attribute VB_Name = "a020_1CopyFilteredData_EX001AA2"
Sub a020_1CopyFilteredData_EX001AA2_()
    ...
    Set wsDest = ThisWorkbook.Sheets("EX001AA2")
    If wsDest Is Nothing Then
        Set wsDest = ThisWorkbook.Sheets.Add
        wsDest.Name = "EX001AA2"
    End If
    On Error GoTo 0
    ...
    ' Apply AutoFilter to filter only rows where Location = NG001VD3
    wsSource.Range(wsSource.Cells(1, 1), wsSource.Cells(lastRow, lastCol)).AutoFilter Field:=locationCol, Criteria1:="EX001AA2"
