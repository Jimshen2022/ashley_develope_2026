...
Select * from Distribution_Warehouse_Wholesale.tranlog where wh_id = '335' and lot_number = '588456622' and start_tran_date >= '2024-01-01' order by lot_number, start_tran_date, start_tran_time
