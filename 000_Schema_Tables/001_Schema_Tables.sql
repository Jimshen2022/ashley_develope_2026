...
select * from dw_developer.tabledictionary where tpktablename LIKE '%Invoice%'  order by tpkRowCount DESC
select * from dw_developer.tabledictionary where tpktablename LIKE '%ATOFILEATOFILE%'  order by tpkRowCount DESC
select * from dw_developer.tabledictionary where tpktablename LIKE '%COMAST%'  order by tpkRowCount DESC
[SupplyChain_Enh]
...
-- item master
select top 10 * from MasterData_ItemMaster_AFI.ITMRVA as a
select top 10 * from MasterData_ItemMaster_AFI.ITBEXT as a
select top 10 * from MasterData_ItemMaster_AFI.ITBEXT as a
