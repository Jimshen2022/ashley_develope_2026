...
'''---------------------------------------------------------------------------------------------'''
# x轴标签设置
# axs.TickLabelPosition =xw.constants.Constants.xlHigh   # 这个与下一个是一样的功能
axs.TickLabelPosition = 4  # -4127图表的顶部或右侧    -4134坐标轴左侧，  4 坐标轴旁边， -4142无刻度线   P284
axs.TickLabelSpacing = 2  # 每隔多少个分类显示一个刻度标签
...
# 设置网格线
# 上下方向的x轴网格线
axs.HasMajorGridlines = True  # 横坐标轴显示主网格线
axs.MajorGridlines.Border.ColorIndex = 3  # 红色
axs.MajorGridlines.Border.LineStyle = xw.constants.LineStyle.xlDash  # 线型

# 左右方向的Y轴网格线
axs2.HasMajorGridlines = True  # 纵坐标显示主网格线
axs2.MajorGridlines.Border.ColorIndex = 3  # 红色
axs2.MajorGridlines.Border.LineStyle = xw.constants.LineStyle.xlDash  # 线型

# 或者用Format属性来设置网格线
axs.MajorGridlines.Format.Line.ForeColor.RGB = xw.utils.rgb_to_int((0, 0, 255))  # 蓝色
axs.MajorGridlines.Format.Line.DashStyle = 4  # 虚线
axs2.MajorGridlines.Format.Line.ForeColor.RGB = xw.utils.rgb_to_int((0, 255, 0))
