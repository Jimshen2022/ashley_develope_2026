...
# chart.api[1].ChartTitle.Text = '标题'                   # 用来设置图表的标题。
# ————————————————
# 版权声明：本文为CSDN博主「寻寻觅觅oO」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
# 原文链接：https://blog.csdn.net/weixin_42146296/article/details/103647839
