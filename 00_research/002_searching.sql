...
select t.wh_id, t.routing_code, t.start_tran_date from Distribution_Warehouse_Wholesale.TranLog as t 
where t.wh_id in ('51','35')
	and t.start_tran_date > '2025-06-01' 
	and t.tran_type = '361' 
	and t.wh_id_2 = '17'
group by t.wh_id, t.routing_code,t.start_tran_date
order by t.wh_id, t.start_tran_date
