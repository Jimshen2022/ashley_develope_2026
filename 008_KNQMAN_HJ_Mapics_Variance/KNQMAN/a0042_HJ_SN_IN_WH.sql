...
with sn as (
	SELECT t1.wh_id, t1.serial_number, t1.item_number, t1.serial_no_status, t1.location_id, t1.received_date  
	FROM t_serial_active  AS t1
	WHERE  t1.wh_id  IN ('335') AND  t1.serial_no_status not in ('O','S') 
),
im as (
...
SELECT t1.wh_id, t1.serial_number, t1.item_number, t1.serial_no_status,  im.serial_no_status as master_status, t1.location_id, t1.received_date  
FROM sn t1
