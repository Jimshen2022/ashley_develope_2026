...
/* ============================================================
   >>>  在此处修改查询参数  <<<
   ============================================================ */
DECLARE @in_vchWhID             NVARCHAR(10)  = 'WH01'          -- 仓库ID
DECLARE @in_vchDispatchStartDate DATETIME     = '2024-01-01'    -- 调度开始日期
DECLARE @in_vchDispatchEndDate   DATETIME     = '2024-01-31'    -- 调度结束日期
