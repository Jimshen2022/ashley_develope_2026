...
WHERE t2.XORDNO =t1.ORDNO AND t3.CUSNO = t1.CCUSNO AND t1.ORDNO=t4.ORDNO AND t1.house IN ('335')
...
GROUP BY ORDNO, ITNBR, ITMSQ) t6 on  a1.ITNBR = t6.ITNBR and a1.ORDNO = t6.ORDNO AND a1.ITMSQ = t6.ITMSQ 
LEFT JOIN
(-- trip demand
...
WHERE t2.BHWHS# IN ('335') AND t2.BHLDAT BETWEEN 0 AND 20261231 AND t2.BHTRPS IN ('A','R','X') AND t1.BDTRP# = t2.BHTRP# 
