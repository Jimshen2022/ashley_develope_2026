...
# Connect to the database
cnxn = pyodbc.connect('DSN=AFIPROD;UID=JIMSHEN;PWD=MJ2078')
cursor = cnxn.cursor()
...
if not data:
    ...
    # Save the workbook to c:\whs335onhand.xlsx
    wb.save(filename="c:\\whs335onhand.xlsx")
    print("Data exported successfully to c:\\whs335onhand.xlsx")
else:
    print("No data found")
