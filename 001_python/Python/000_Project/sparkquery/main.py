...
def create_spark_session():
    return SparkSession.builder         .appName("DatabaseParallelQuery")         .config("spark.executor.memory", "4g")         .config("spark.driver.memory", "2g")         .config("spark.sql.shuffle.partitions", "12")         .getOrCreate()
