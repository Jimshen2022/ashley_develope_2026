...
def load_rp_open_orders(excel_path):
    ...
    # 使用已配置的 DSN 名称进行连接
    conn_str = f"DSN=AFIPROD;UID={uname};PWD={upass};"
    ...
    df.to_excel(excel_path, sheet_name="RPOpenOrders", index=False, startrow=1, engine='openpyxl')
...
def main():
    excel_path = r'D:\Documents\08-Ashton_Phu_my\03-RP\Python\Ashton RP Open Orders Fulfillment_v01.xlsx'
