WITH ContainerDetails AS (
    ...
    WHERE a.WCIORIGIN IN ('35','33')
      AND a.WCILASTMAINTENANCETIMESTAMP >= DATEADD(DAY, -65, CAST(GETDATE() AS DATE))
      AND a.WCILASTMAINTENANCETIMESTAMP <= CAST(GETDATE() AS DATE)
...
HeaderDetails AS (
    ...
    WHERE a.WCHCONTAINERSTATUS IN ('P', 'T')
      ...
      AND a.WCHPOSTEDTIMESTAMP >= DATEADD(DAY, -60, CAST(GETDATE() AS DATE))
      AND a.WCHPOSTEDTIMESTAMP <= CAST(GETDATE() AS DATE)
