...
SELECT 
    ...
    CASE 
        ...
        ELSE VARCHAR_FORMAT(TIMESTAMP_FORMAT(CHAR(a1.MFIDT), 'YYYYMMDD'), 'YYYY-MM-DD')
    ...
    CASE 
        ...
        ELSE    
            VARCHAR_FORMAT(
                DATE(TIMESTAMP_FORMAT(CHAR(a1.MFIDT), 'YYYYMMDD')) + 
                (6 - DAYOFWEEK_ISO(DATE(TIMESTAMP_FORMAT(CHAR(a1.MFIDT), 'YYYYMMDD')))) DAYS,
            'YYYY-MM-DD')
    END AS WeekSaturday
