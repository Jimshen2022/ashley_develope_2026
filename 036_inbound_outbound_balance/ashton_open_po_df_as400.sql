...
WHERE t1.ORDNO = t2.ORDNO AND t2.HOUSE = t1.HOUSE AND t1.ITNBR = T3.ITNBR AND T1.HOUSE = T3.STID AND (t1.HOUSE='335') AND T2.PSTTS IN ('20','30')  AND t1.DUEDT >= '1250101'
) AS T1
...
WHERE t1.ORDNO = t2.ORDNO AND t2.HOUSE = t1.HOUSE AND t1.ITNBR = T3.ITNBR AND T1.HOUSE = T3.STID AND (t1.HOUSE='335') AND T2.PSTTS IN ('10','20','30')  AND t1.DUEDT >= '1250101'
) AS T1
LEFT JOIN AMFLIBA.VENNAML0 t3 on t1.VNDNR=t3.VNDRVM
group by t1.ORDNO, TRIM(t1.ITNBR),t1.HOUSE,T1.ITCLS,T1.DUEDT,T1.VNDNR,T1.PSTTS, t3.VNDRVM,t3.VNNMVM, T1.ITDSC, T1.Unit_CBM,
CASE
