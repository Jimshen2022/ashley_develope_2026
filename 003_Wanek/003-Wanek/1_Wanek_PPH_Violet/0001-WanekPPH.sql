...
DECLARE
    ...
    @StartDate DATETIME,
    @EndDate DATETIME;
SET @StartDate = DATEADD(DAY, -6, CAST(CAST(GETDATE() AS DATE) AS DATETIME)) + '07:00:00.000';
    ...
    WHEN t1.wh_id = '35' THEN
        CASE
            ...
            WHEN t1.tran_type = '202' THEN
                CASE
                    WHEN t1.location_id_2 LIKE 'C%WN3' AND t1.control_number_2 LIKE 'DK%' THEN 'WN3'
