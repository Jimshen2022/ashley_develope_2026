...
LEFT JOIN AFILELIB.ITBEXT AS t2 ON t2.ITNBR = t1.ITNBR AND t2.HOUSE = t1.STID
LEFT JOIN AFILELIB.ITMEXT AS t3 ON t3.ITNBR = t1.ITNBR
LEFT JOIN ITEMBL_CTE AS t4 ON t1.ITNBR = t4.ITNBR AND t1.STID = t4.HOUSE
WHERE t1.STID = '335' AND t4.MOHTQ > 0