SELECT 	t1.wh_id
	...
	, SUBSTRING(t1.control_number_2, PATINDEX('%[^0]%', t1.control_number_2), CHARINDEX('-', t1.control_number_2) - PATINDEX('%[^0]%', t1.control_number_2)) as tripNbr
    ...
    WHEN SUBSTRING(LTRIM(RTRIM(t1.item_number)), 1, 1) IN ('1','2','3','4','5','6','7','8','9','U') THEN 'UPH'
    ...
    WHEN LEN(LTRIM(RTRIM(t1.item_number))) = 6 AND SUBSTRING(LTRIM(RTRIM(t1.item_number)), 1, 1) = 'M' THEN 'ACCESSORY'
    ELSE 'CG'
END AS Product
