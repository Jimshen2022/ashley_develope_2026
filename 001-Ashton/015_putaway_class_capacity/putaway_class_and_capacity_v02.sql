...
select top 10 *  from  t_class_loca where location_id like 'A3011CA1%'
select top 10 *  from  t_loc_pallet_capacity  where location_id = 'A3011CA1'
...
WHERE 1=1
   -- SUBSTRING(t0.location_id,1,5) IN ('A3010','A3011')  
