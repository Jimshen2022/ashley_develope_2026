...
WITH base AS (
    ...
    WHERE t01.ndate BETWEEN 20260101 AND DEC( VARCHAR_FORMAT(CURRENT_DATE - 1 DAY, 'YYYYMMDD'), 8, 0 )
...
rk_filtered AS (
    SELECT *
    FROM rk_mulcode 
    WHERE MAXDATE BETWEEN DEC(VARCHAR_FORMAT(CURRENT_DATE - 30 DAYS, 'YYYYMMDD'), 8, 0)
