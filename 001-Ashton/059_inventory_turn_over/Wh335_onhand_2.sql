...
SELECT a.ITNBR,a.HOUSE, a.ITCLS, a.MOHTQ, b.PAMNT "UP($USD)", Z.product_category,
CASE
    WHEN a.ITCLS NOT LIKE 'Z%' THEN 'RP'
    WHEN Z.ITMCLSID = 'RUGS' THEN 'RGUS'
    WHEN Z.ITMCLSID = 'FLOOR' THEN 'BULK'
    WHEN Z.ITMCLSID LIKE 'UPH%' THEN 'UPH'
    WHEN Z.ITMCLSID LIKE 'PAL%' THEN 'CG'
    WHEN Z.ITMCLSID LIKE 'RAIL%' THEN 'CG'
    WHEN Z.ITMCLSID LIKE 'MATT%' THEN 'CG'
    WHEN Z.ITMCLSID = 'RUGSS' THEN 'CG'
    WHEN Z.ITMCLSID IS NULL AND Z.PICKPUT = 'UPH' THEN 'UPH'
...
ON a.ITNBR = b.PITEM 
LEFT JOIN itm AS Z ON a.ITNBR = Z.ITNBR 