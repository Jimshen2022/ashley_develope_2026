...
(CASE 
	WHEN SUBSTRING(r0.location_id,6,1) IN ('C','E','G','J','L','N','Q','S','U','W','Y') THEN 'A' 
	WHEN SUBSTRING(r0.location_id,6,1) IN ('D','F','H','K','M','P','R','T','V','X','Z') THEN 'B' 
	ELSE 'Check' END
	) AS Location_side,
(CASE
...
AND SUBSTRING(t1.location_id,4,2) IN ('10','11','12','13','14','15','16','17','18') 
