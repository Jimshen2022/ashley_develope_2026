...
SELECT t1.wh_id
	...
	, t1.location_id
	, CASE
			WHEN t1.location_id = 'DM001AA1' THEN 'Main Location for Damaged & Defective Items'
			WHEN t1.location_id = 'NG001MT1' THEN 'Mattress Inspection Area (Over 150 Days)'
			WHEN t1.location_id = 'VD001AA1' THEN 'Vendor Damaged Inbound Area'
			WHEN t1.location_id = 'EX001AA1' THEN 'Vendor Over Shipment Area'
			WHEN t1.location_id = 'EX001AA2' THEN 'Operation Issue Extra Stock Area'
			WHEN t1.location_id = 'SH001AA1' THEN 'Vendor Short Shipment Area'
			WHEN t1.location_id = 'NG001CK3' THEN 'Piece Inspection Area (Repair Material Shortage)'
			WHEN t1.location_id = 'NG001CG3' THEN 'Whse Damaged Area'
			WHEN t1.location_id = 'NG001UP3' THEN 'Whse Damaged Area'
			WHEN t1.location_id = 'NG001VD3' THEN 'Returned to Vendor for Repair'
