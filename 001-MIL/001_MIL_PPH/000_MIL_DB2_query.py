...
def fetch_data(query, connection_string='DSN=WFVNPROD;UID=JIMSHEN;PWD=MJ2083'):
    """从数据库获取数据"""
    try:
...
SELECT WCICNTNR, WCIORIGN, WCIDESTN, WCIORDRN, WCIITNBR, WCIQTLOD, WCILSMTS, WCILSMUS, ITMCQTY AS Box_Qty,CUBES, ITMITCLS    
FROM DISTLIBW.WVCNTID, AFILELIBW.ITMEXT
WHERE WCIITNBR=ITNBR 
    AND WCILSMTS between '2025-08-04-07.00.00.000000' and '2025-08-08-06.59.59.999999'
