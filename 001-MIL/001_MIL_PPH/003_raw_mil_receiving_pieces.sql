...
SELECT 
    ...
    CASE
        WHEN
            ...
            CAST(ToTier AS VARCHAR) IN ('HJ001AA1','HJ001AA2','HJ001AA3','HJ001AA4','HJ001AA5')
        THEN 'Receiving'
        WHEN ActivityCodeOne = 'CN' AND Equipment like 'UNK%' AND
            ...
            CAST(FromTier AS VARCHAR) IN ('HJ001AA1','HJ001AA2','HJ001AA3','HJ001AA4','HJ001AA5')
        THEN 'Unloading'
        ELSE NULL
    END AS pph_type,
    ...
    CASE
        ...
        WHEN
            ...
            RIGHT('000' + CAST(ToAisle AS VARCHAR), 3) +
            CAST(ToSection AS VARCHAR) +
            CAST(ToTier AS VARCHAR) IN ('HJ001AA3','HJ001AA5')
        THEN 'B3'
        WHEN
            ActivityCodeOne = 'MV' AND CAST(ToArea AS VARCHAR) +
            RIGHT('000' + CAST(ToAisle AS VARCHAR), 3) +
